  ...
  return (
    <div class="relative overflow-hidden bg-white pt-16">
          ...
          <main class="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div class="sm:text-center lg:text-left">
              <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                <span class="block xl:inline">Premium Storefront</span>{" "}
                <span class="block text-indigo-600 xl:inline">for TStack</span>
              </h1>
              <p class="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">
                A fully responsive, SEO-optimized, and highly performant
                storefront starter template powered by Fresh and Tailwind CSS.
      ...
      <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <div
          class="h-56 w-full sm:h-72 md:h-96 lg:h-full lg:w-full bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500"
