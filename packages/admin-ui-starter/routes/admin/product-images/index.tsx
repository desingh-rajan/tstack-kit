...
import type { ProductImage } from "@/entities/product-images/product-image.types.ts";
...
export default define.page<typeof handler>(function ProductImagesListPage({
  data,
}) {
  const { items, config, error, errorStatus, url } = data;
  const response = items as ListResponse<ProductImage>;
