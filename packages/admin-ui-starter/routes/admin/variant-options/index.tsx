...
import type { VariantOption } from "@/entities/variant-options/variant-option.types.ts";
...
export default define.page<typeof handler>(function VariantOptionsListPage({
  data,
}) {
  const { items, config, error, errorStatus, url } = data;
  const response = items as ListResponse<VariantOption>;
