...
describe(
  { name: "Auth API", sanitizeResources: false, sanitizeOps: false },
  () => {
    // ----------------------------------------------------------------------------
    // SETUP & TEARDOWN
    // ----------------------------------------------------------------------------
    ...
    describe(
      { name: "Login", sanitizeResources: false, sanitizeOps: false },
      () => {
    ...
    describe(
      { name: "Logout", sanitizeResources: false, sanitizeOps: false },
      () => {
