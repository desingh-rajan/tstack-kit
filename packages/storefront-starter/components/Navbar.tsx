...
interface NavbarProps {
  ...
  cartCount?: number;
  /**
   * If true, hides the main navigation links (Home, Products, etc.).
   * Useful for Checkout or Login pages.
   */
  minimal?: boolean;
  /**
   * Optional override for the right-side content (Cart/UserMenu).
   * Useful for showing "Back to Cart" or other contextual actions.
   */
